...
#    Updated: 2023/04/19 10:59:00 by vde-vasc         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
PARSER	= $(addprefix Parser/, expander.c prompt.c tokenizer.c handling_var.c lexer.c parser.c system.c parser_utils.c sentence.c)
...
DEVELOP	=	$(addprefix develop/, quote.c relative.c)
